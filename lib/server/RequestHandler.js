...
var RequestHandler = function () {
	function RequestHandler(config, reactRouter) {
		...
		this.request = null;
		this.response = null;
		this.processChain = [(0, _compression2.default)(), (0, _serveStatic2.default)(staticFolder), _Utils2.default.fixQuery(), (0, _cookieParser2.default)(), _bodyParser2.default.json(), _bodyParser2.default.urlencoded({ extended: true })];
