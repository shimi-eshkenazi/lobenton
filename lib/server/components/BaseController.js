...
var _index = require("../../client/reducers/index.js");
...
var BaseController = function (_BaseComponent) {
	...
	_createClass(BaseController, [{
		...
		value: function dispatchToStore(sourceState) {
			var mainReducers = require('src/client/reducers');
			...
			this.store = (0, _ConfigureStore2.default)(function rootReducer(state, action) {
				var topResult = (0, _index2.default)(state, action);
				var mainResult = mainReducers(sourceState, action);
				var result = (0, _deepAssign2.default)(mainResult, topResult);
				return result;
		...
		value: function render(passToLayoutWithoutRedux, sourceState) {
			if (passToLayoutWithoutRedux || sourceState) {
				var type = (typeof passToLayoutWithoutRedux === "undefined" ? "undefined" : _typeof(passToLayoutWithoutRedux)) || (typeof sourceState === "undefined" ? "undefined" : _typeof(sourceState));

				if ((typeof passToLayoutWithoutRedux === "undefined" ? "undefined" : _typeof(passToLayoutWithoutRedux)) !== 'object' || (typeof sourceState === "undefined" ? "undefined" : _typeof(sourceState)) !== 'object') {
			...
			try {
				...
				var view = _react2.default.createElement(viewSource, {});
				var layout = _react2.default.createElement(layoutSource, passToLayoutWithoutRedux, view);
				var app = _react2.default.createElement(_App2.default, {}, layout);
				var i18nextProvider = _react2.default.createElement(_reactI18next.I18nextProvider, { i18n: this.i18nDetectorInstance }, app);
		...
		value: function cookie(name, value, options) {
			this.response.setHeader('Set-Cookie', _cookie3.default.serialize(name, String(value), options));
		}
	}, {
		key: "createUrl",
