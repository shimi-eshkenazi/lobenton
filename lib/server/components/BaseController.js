...
var BaseController = function (_BaseComponent) {
	...
	_createClass(BaseController, [{
		...
		value: function initial(fromRequest) {
			var localesUrl = this.config.isStart ? "lib/client/locales" : "src/client/locales";
		...
		value: function dispatchToStore(sourceState) {
			var reducerUrl = this.config.isStart ? "lib/client/reducers" : "src/client/reducers";
			var mainReducers = require(reducerUrl);
		...
		value: function render(passToLayoutWithoutRedux, sourceState) {
			...
			try {
				(function () {
					...
					var routes = createRouter(history);

					sourceState = sourceState || {};

					if (_this2.layout) {
						if (_this2.config.isStart) {
