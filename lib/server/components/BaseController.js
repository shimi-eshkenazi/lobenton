	...
	_createClass(BaseController, [{
		...
		value: function dispatchToStore(sourceState) {
			...
			this.store = (0, _ConfigureStore2.default)(function rootReducer(state, action) {
				...
				var mainResult = mainReducers(state, action);
		...
		value: function render(passToLayoutWithoutRedux, sourceState) {
			...
			try {
				...
				var view = _react2.default.createElement(viewSource, passToLayoutWithoutRedux);
				var layout = _react2.default.createElement(layoutSource, passToLayoutWithoutRedux, view);
				var app = _react2.default.createElement(_App2.default, { params: this.getParamMap(), location: {} }, layout);
		...
		value: function clearCookie(name) {
			this.response.setHeader('Set-Cookie', _cookie3.default.serialize(name, "", { maxAge: -900000, httpOnly: false }));
		}
	}, {
		key: "createUrl",
