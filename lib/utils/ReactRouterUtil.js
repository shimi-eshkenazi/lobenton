...
var ReactRouterUtil = function () {
	...
	function ReactRouterUtil() {
		...
		this.router = null;
		this.importArray = ['"use strict";', '', 'import {App} from "lobenton/client";', 'import React from "react";', 'import { Router, Route, IndexRoute } from "react-router";'];
		this.mainBeforeArray = ['', 'export const ts = ' + new Date().getTime() + ";", 'export default function createRouter(history) {', '\treturn (', '\t\t<Router history={history}>'];
