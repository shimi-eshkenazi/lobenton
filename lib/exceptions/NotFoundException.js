...
var NotFoundException = function (_ExtendableError) {
	_inherits(NotFoundException, _ExtendableError);

	function NotFoundException(message) {
		_classCallCheck(this, NotFoundException);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NotFoundException).call(this, message));
